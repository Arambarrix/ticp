<script setup>
    ...
    const props = defineProps({'teams':Array, 'show_header':String});
...
<template>
    <div class="px-20 py-10 ">
        ...
        <div v-if="show_header=='true'" class="flex flex-row justify-between" >
        ...
        <div class="flex flex-col px-2 pb-8" :class="show_header=='true'?'pt-10':''">
